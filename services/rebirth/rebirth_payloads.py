...
def public_rebirth_state(match):
    ...
    return {
        ...
        "selected_deck_id": match.get("selected_deck_id"),
        "selected_deck_name": match.get("selected_deck_name"),
        "difficulty": match.get("difficulty"),
        "difficulty_label": match.get("difficulty_label"),
        "opponent_profile": deepcopy(match.get("opponent_profile")),
        "player": player,
        "opponent": opponent,
        ...
        "match_summary": deepcopy(match.get("match_summary")),
        "reward_preview": deepcopy(match.get("reward_preview")),
