...
REBIRTH_RELEASE_VERSION = os.environ.get("REBIRTH_RELEASE_VERSION", "v134_CARD_NAME_WRAP")
...
@app.get("/rebirth/novidades")
def rebirth_novidades_page():
    from services.rebirth_patch_notes import patch_notes_payload

    return render_template(
        "rebirth_novidades.html",
        account=account_payload(current_user()),
        notes=patch_notes_payload(),
    )
