...
def test_rebirth_service_worker_caches_active_reference_assets():
    ...
    assert 'const ASSET_VERSION = "v119_ONBOARDING_FINALE";' in service_worker
    assert 'REBIRTH_RELEASE_VERSION = os.environ.get("REBIRTH_RELEASE_VERSION", "v119_ONBOARDING_FINALE")' in app_runtime
    assert "`ASSET_VERSION` permanece alinhada ao runtime web: `v119_ONBOARDING_FINALE`." in internal_testing_readiness
    ...
    assert "ARENA_ACTIONS" in service_worker
