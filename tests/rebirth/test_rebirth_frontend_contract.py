...
def test_rebirth_service_worker_caches_active_reference_assets():
    ...
    assert 'const ASSET_VERSION = "v129_PVP_ASYNC";' in service_worker
    assert 'REBIRTH_RELEASE_VERSION = os.environ.get("REBIRTH_RELEASE_VERSION", "v129_PVP_ASYNC")' in app_runtime
    assert "`ASSET_VERSION` permanece alinhada ao runtime web: `v129_PVP_ASYNC`." in internal_testing_readiness
