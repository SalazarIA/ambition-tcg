...
def test_rebirth_service_worker_caches_active_reference_assets():
    ...
    assert 'const CACHE_NAME = "v87_LAUNCH-2";' in service_worker
    assert '"version": "v87_LAUNCH-2"' in asset_manifest
    assert 'REBIRTH_ART_VERSION = "v87_LAUNCH-2"' in art_contract
