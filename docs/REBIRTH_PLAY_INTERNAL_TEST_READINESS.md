...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v109_READABILITY`. |
...
- A página de suporte mostra `Versão v109_READABILITY`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v109_READABILITY`.
