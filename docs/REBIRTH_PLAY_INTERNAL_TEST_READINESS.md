...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v117_SHOWCASE_POLISH`. |
...
- A página de suporte mostra `Versão v117_SHOWCASE_POLISH`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v117_SHOWCASE_POLISH`.
