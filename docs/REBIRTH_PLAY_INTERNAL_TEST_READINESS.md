...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v130_PVP_LIVE`. |
...
- A página de suporte mostra `Versão v130_PVP_LIVE`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v130_PVP_LIVE`.
