...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v111_CLEAN_BOARD`. |
...
- A página de suporte mostra `Versão v111_CLEAN_BOARD`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v111_CLEAN_BOARD`.
