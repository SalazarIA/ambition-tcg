...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v120_ARENA_REWORK`. |
...
- A página de suporte mostra `Versão v120_ARENA_REWORK`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v120_ARENA_REWORK`.
