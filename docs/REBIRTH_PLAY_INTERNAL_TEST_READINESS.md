...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v129_PVP_ASYNC`. |
...
- A página de suporte mostra `Versão v129_PVP_ASYNC`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v129_PVP_ASYNC`.
