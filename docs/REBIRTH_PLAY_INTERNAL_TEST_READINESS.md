...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v115_PROFILE_AVATARS`. |
...
- A página de suporte mostra `Versão v115_PROFILE_AVATARS`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v115_PROFILE_AVATARS`.
