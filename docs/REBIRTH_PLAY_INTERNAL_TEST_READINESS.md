...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v114_BOARD_LAYOUT`. |
...
- A página de suporte mostra `Versão v114_BOARD_LAYOUT`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v114_BOARD_LAYOUT`.
