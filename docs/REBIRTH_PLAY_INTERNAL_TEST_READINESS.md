...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v126_AV_POLISH`. |
...
- A página de suporte mostra `Versão v126_AV_POLISH`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v126_AV_POLISH`.
