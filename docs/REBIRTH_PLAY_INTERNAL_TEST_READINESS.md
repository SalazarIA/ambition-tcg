...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v118_HERO_SYMMETRY`. |
...
- A página de suporte mostra `Versão v118_HERO_SYMMETRY`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v118_HERO_SYMMETRY`.
