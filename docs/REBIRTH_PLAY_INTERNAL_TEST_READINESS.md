...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v123_CRAFTING`. |
...
- A página de suporte mostra `Versão v123_CRAFTING`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v123_CRAFTING`.
