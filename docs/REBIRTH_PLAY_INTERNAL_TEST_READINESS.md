...
|---|---|---|
| Produção Rebirth | Operacional com divergências | `ambitionzgame.com` entrega Arena, campanha, coleção, deck builder, loja, recompensas, ranking, perfil e suporte; o suporte expõe `v116_PROFILE_PICKER`. |
...
- A página de suporte mostra `Versão v116_PROFILE_PICKER`.
...
- `ASSET_VERSION` permanece alinhada ao runtime web: `v116_PROFILE_PICKER`.
