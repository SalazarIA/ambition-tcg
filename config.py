...
class Config:
    ...
    PASSWORD_RESET_RATE_WINDOW_MINUTES = int(os.environ.get("PASSWORD_RESET_RATE_WINDOW_MINUTES", "60"))
    BETA_EVENT_RATE_LIMIT = int(os.environ.get("BETA_EVENT_RATE_LIMIT", "60"))
    BETA_EVENT_RATE_WINDOW_SECONDS = int(os.environ.get("BETA_EVENT_RATE_WINDOW_SECONDS", "60"))
    RETENTION_EVENT_RATE_LIMIT = int(os.environ.get("RETENTION_EVENT_RATE_LIMIT", "120"))
    RETENTION_EVENT_RATE_WINDOW_SECONDS = int(os.environ.get("RETENTION_EVENT_RATE_WINDOW_SECONDS", "60"))
