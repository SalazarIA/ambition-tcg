...
4024:     emit_az48_state_for_sid()
4027: @socketio.on("az48_declare_ready")
4028: def az48_declare_ready(data=None):
4030:     emit_az48_state_for_sid(message="Ready. Waiting for battle resolution.")
```
