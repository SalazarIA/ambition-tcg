...
var q = class e {
	...
	*[Symbol.iterator]() {
...
}, ot = /* @__PURE__ */ new J(), st = /* @__PURE__ */ new at(), Y = class e {
	static {
	...
	scale(e, t) {
		return this.premultiply(ct.makeScale(e, t)), this;
	}
	rotate(e) {
		return this.premultiply(ct.makeRotation(-e)), this;
	}
	translate(e, t) {
		return this.premultiply(ct.makeTranslation(e, t)), this;
	}
	makeTranslation(e, t) {
...
}, ct = /* @__PURE__ */ new Y(), lt = /* @__PURE__ */ new Y().set(.4123908, .3575843, .1804808, .212639, .7151687, .0721923, .0193308, .1191948, .9505322), ut = /* @__PURE__ */ new Y().set(3.2409699, -1.5373832, -.4986108, -.9692436, 1.8759675, .0415551, .0556301, -.203977, 1.0569715);
function dt() {
	let e = {
		enabled: !0,
		...
		convert: function(e, t, n) {
			return this.enabled === !1 || t === n || !t || !n ? e : (this.spaces[t].transfer === "srgb" && (e.r = ft(e.r), e.g = ft(e.g), e.b = ft(e.b)), this.spaces[t].primaries !== this.spaces[n].primaries && (e.applyMatrix3(this.spaces[t].toXYZ), e.applyMatrix3(this.spaces[n].fromXYZ)), this.spaces[n].transfer === "srgb" && (e.r = pt(e.r), e.g = pt(e.g), e.b = pt(e.b)), e);
		},
...
var mt, ht = class {
	...
	constructor(e = null) {
		this.isSource = !0, Object.defineProperty(this, "id", { value: gt++ }), this.uuid = et(), this.data = e, this.dataReady = !0, this.version = 0;
	}
	getSize(e) {
		let t = this.data;
...
function vt(e) {
	return typeof HTMLImageElement < "u" && e instanceof HTMLImageElement || typeof HTMLCanvasElement < "u" && e instanceof HTMLCanvasElement || typeof ImageBitmap < "u" && e instanceof ImageBitmap ? ht.getDataURL(e) : e.data ? {
...
var St = class e {
	...
	*[Symbol.iterator]() {
	...
	extractRotation(e) {
		...
		let t = this.elements, n = e.elements, r = 1 / Ot.setFromMatrixColumn(e, 0).length(), i = 1 / Ot.setFromMatrixColumn(e, 1).length(), a = 1 / Ot.setFromMatrixColumn(e, 2).length();
	...
	lookAt(e, t, n) {
		let r = this.elements;
		return Pt.subVectors(e, t), Pt.lengthSq() === 0 && (Pt.z = 1), Pt.normalize(), Mt.crossVectors(n, Pt), Mt.lengthSq() === 0 && (Math.abs(n.z) === 1 ? Pt.x += 1e-4 : Pt.z += 1e-4, Pt.normalize(), Mt.crossVectors(n, Pt)), Mt.normalize(), Nt.crossVectors(Pt, Mt), r[0] = Mt.x, r[4] = Nt.x, r[8] = Pt.x, r[1] = Mt.y, r[5] = Nt.y, r[9] = Pt.y, r[2] = Mt.z, r[6] = Nt.z, r[10] = Pt.z, this;
	}
	multiply(e) {
		return this.multiplyMatrices(this, e);
	}
	...
	decompose(e, t, n) {
		...
		let a = Ot.set(r[0], r[1], r[2]).length(), o = Ot.set(r[4], r[5], r[6]).length(), s = Ot.set(r[8], r[9], r[10]).length();
		i < 0 && (a = -a), kt.copy(this);
		let c = 1 / a, l = 1 / o, u = 1 / s;
		return kt.elements[0] *= c, kt.elements[1] *= c, kt.elements[2] *= c, kt.elements[4] *= l, kt.elements[5] *= l, kt.elements[6] *= l, kt.elements[8] *= u, kt.elements[9] *= u, kt.elements[10] *= u, t.setFromRotationMatrix(kt), n.x = a, n.y = o, n.z = s, this;
	}
...
}, Ot = /* @__PURE__ */ new J(), kt = /* @__PURE__ */ new Dt(), At = /* @__PURE__ */ new J(0, 0, 0), jt = /* @__PURE__ */ new J(1, 1, 1), Mt = /* @__PURE__ */ new J(), Nt = /* @__PURE__ */ new J(), Pt = /* @__PURE__ */ new J(), Ft = /* @__PURE__ */ new Dt(), It = /* @__PURE__ */ new at(), Lt = class e {
	...
	setFromQuaternion(e, t, n) {
		return Ft.makeRotationFromQuaternion(e), this.setFromRotationMatrix(Ft, t, n);
	}
...
var Rt = class {
...
}, zt = 0, Bt = /* @__PURE__ */ new J(), Vt = /* @__PURE__ */ new at(), Ht = /* @__PURE__ */ new Dt(), Ut = /* @__PURE__ */ new J(), Wt = /* @__PURE__ */ new J(), Gt = /* @__PURE__ */ new J(), Kt = /* @__PURE__ */ new at(), qt = /* @__PURE__ */ new J(1, 0, 0), Jt = /* @__PURE__ */ new J(0, 1, 0), Yt = /* @__PURE__ */ new J(0, 0, 1), Xt = { type: "added" }, Zt = { type: "removed" }, Qt = {
	type: "childadded",
	child: null
}, $t = {
	type: "childremoved",
	child: null
}, en = class e extends Xe {
	constructor() {
		super(), this.isObject3D = !0, Object.defineProperty(this, "id", { value: zt++ }), this.uuid = et(), this.name = "", this.type = "Object3D", this.parent = null, this.children = [], this.up = e.DEFAULT_UP.clone();
		let t = new J(), n = new Lt(), r = new at(), i = new J(1, 1, 1);
		function a() {
			r.setFromEuler(n, !1);
		}
		function o() {
		...
		}), this.matrix = new Dt(), this.matrixWorld = new Dt(), this.matrixAutoUpdate = e.DEFAULT_MATRIX_AUTO_UPDATE, this.matrixWorldAutoUpdate = e.DEFAULT_MATRIX_WORLD_AUTO_UPDATE, this.matrixWorldNeedsUpdate = !1, this.layers = new Rt(), this.visible = !0, this.castShadow = !1, this.receiveShadow = !1, this.frustumCulled = !0, this.renderOrder = 0, this.animations = [], this.customDepthMaterial = void 0, this.customDistanceMaterial = void 0, this.static = !1, this.userData = {}, this.pivot = null;
	}
	onBeforeShadow() {}
	onAfterShadow() {}
	onBeforeRender() {}
	...
	lookAt(e, t, n) {
		...
		let r = this.parent;
		this.updateWorldMatrix(!0, !1), Wt.setFromMatrixPosition(this.matrixWorld), this.isCamera || this.isLight ? Ht.lookAt(Wt, Ut, this.up) : Ht.lookAt(Ut, Wt, this.up), this.quaternion.setFromRotationMatrix(Ht), r && (Ht.extractRotation(r.matrixWorld), Vt.setFromRotationMatrix(Ht), this.quaternion.premultiply(Vt.invert()));
	}
	add(e) {
		...
		return e === this ? (G("Object3D.add: object can't be added as a child of itself.", e), this) : (e && e.isObject3D ? (e.removeFromParent(), e.parent = this, this.children.push(e), e.dispatchEvent(Xt), Qt.child = e, this.dispatchEvent(Qt), Qt.child = null) : G("Object3D.add: object not an instance of THREE.Object3D.", e), this);
	}
	remove(e) {
		if (arguments.length > 1) {
		...
		return t !== -1 && (e.parent = null, this.children.splice(t, 1), e.dispatchEvent(Zt), $t.child = e, this.dispatchEvent($t), $t.child = null), this;
	}
	removeFromParent() {
		let e = this.parent;
	...
	getWorldQuaternion(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Wt, e, Gt), e;
	}
	getWorldScale(e) {
		return this.updateWorldMatrix(!0, !1), this.matrixWorld.decompose(Wt, Kt, e), e;
	}
	getWorldDirection(e) {
...
en.DEFAULT_UP = /* @__PURE__ */ new J(0, 1, 0), en.DEFAULT_MATRIX_AUTO_UPDATE = !0, en.DEFAULT_MATRIX_WORLD_AUTO_UPDATE = !0;
var tn = class extends en {
	constructor() {
		super(), this.isGroup = !0, this.type = "Group";
	}
}, nn = { type: "move" }, rn = class {
	constructor() {
	...
	getTargetRaySpace() {
		return this._targetRay === null && (this._targetRay = new tn(), this._targetRay.matrixAutoUpdate = !1, this._targetRay.visible = !1, this._targetRay.hasLinearVelocity = !1, this._targetRay.linearVelocity = new J(), this._targetRay.hasAngularVelocity = !1, this._targetRay.angularVelocity = new J()), this._targetRay;
	}
	getGripSpace() {
		return this._grip === null && (this._grip = new tn(), this._grip.matrixAutoUpdate = !1, this._grip.visible = !1, this._grip.hasLinearVelocity = !1, this._grip.linearVelocity = new J(), this._grip.hasAngularVelocity = !1, this._grip.angularVelocity = new J(), this._grip.eventsEnabled = !1), this._grip;
	}
	dispatchEvent(e) {
	...
	update(e, t, n) {
		...
		if (e && t.session.visibilityState !== "visible-blurred") {
			...
			o !== null && (r = t.getPose(e.targetRaySpace, n), r === null && i !== null && (r = i), r !== null && (o.matrix.fromArray(r.transform.matrix), o.matrix.decompose(o.position, o.rotation, o.scale), o.matrixWorldNeedsUpdate = !0, r.linearVelocity ? (o.hasLinearVelocity = !0, o.linearVelocity.copy(r.linearVelocity)) : o.hasLinearVelocity = !1, r.angularVelocity ? (o.hasAngularVelocity = !0, o.angularVelocity.copy(r.angularVelocity)) : o.hasAngularVelocity = !1, this.dispatchEvent(nn)));
		}
...
var Z = class {
	...
	setHSL(e, t, n, r = X.workingColorSpace) {
		if (e = tt(e, 1), t = K(t, 0, 1), n = K(n, 0, 1), t === 0) this.r = this.g = this.b = n;
		else {
	...
	getHex(e = Me) {
		return X.workingToColorSpace(ln.copy(this), e), Math.round(K(ln.r * 255, 0, 255)) * 65536 + Math.round(K(ln.g * 255, 0, 255)) * 256 + Math.round(K(ln.b * 255, 0, 255));
	}
	getHexString(e = Me) {
		return ("000000" + this.getHex(e).toString(16)).slice(-6);
	}
	getHSL(e, t = X.workingColorSpace) {
		X.workingToColorSpace(ln.copy(this), t);
		let n = ln.r, r = ln.g, i = ln.b, a = Math.max(n, r, i), o = Math.min(n, r, i), s, c, l = (o + a) / 2;
		if (o === a) s = 0, c = 0;
		else {
			let e = a - o;
	...
	getRGB(e, t = X.workingColorSpace) {
		return X.workingToColorSpace(ln.copy(this), t), e.r = ln.r, e.g = ln.g, e.b = ln.b, e;
	}
	getStyle(e = Me) {
		X.workingToColorSpace(ln.copy(this), e);
		let t = ln.r, n = ln.g, r = ln.b;
	...
	lerpHSL(e, t) {
		...
		let n = nt(on.h, sn.h, t), r = nt(on.s, sn.s, t), i = nt(on.l, sn.l, t);
...
var un = class e {
	constructor(e, t = 1, n = 1e3) {
		this.isFog = !0, this.name = "", this.color = new Z(e), this.near = t, this.far = n;
	}
	clone() {
...
}, fn = /* @__PURE__ */ new J(), pn = /* @__PURE__ */ new J(), mn = /* @__PURE__ */ new J(), hn = /* @__PURE__ */ new J(), gn = /* @__PURE__ */ new J(), _n = /* @__PURE__ */ new J(), vn = /* @__PURE__ */ new J(), yn = /* @__PURE__ */ new J(), bn = /* @__PURE__ */ new J(), xn = /* @__PURE__ */ new J(), Sn = /* @__PURE__ */ new St(), Cn = /* @__PURE__ */ new St(), wn = /* @__PURE__ */ new St(), Tn = class e {
	constructor(e = new J(), t = new J(), n = new J()) {
		this.a = e, this.b = t, this.c = n;
	}
	static getNormal(e, t, n, r) {
		r.subVectors(n, t), fn.subVectors(e, t), r.cross(fn);
		let i = r.lengthSq();
		return i > 0 ? r.multiplyScalar(1 / Math.sqrt(i)) : r.set(0, 0, 0);
	}
	static getBarycoord(e, t, n, r, i) {
		fn.subVectors(r, t), pn.subVectors(n, t), mn.subVectors(e, t);
		let a = fn.dot(fn), o = fn.dot(pn), s = fn.dot(mn), c = pn.dot(pn), l = pn.dot(mn), u = a * c - o * o;
	...
	static getInterpolation(e, t, n, r, i, a, o, s) {
		return this.getBarycoord(e, t, n, r, hn) === null ? (s.x = 0, s.y = 0, "z" in s && (s.z = 0), "w" in s && (s.w = 0), null) : (s.setScalar(0), s.addScaledVector(i, hn.x), s.addScaledVector(a, hn.y), s.addScaledVector(o, hn.z), s);
	}
	static getInterpolatedAttribute(e, t, n, r, i, a) {
		return Sn.setScalar(0), Cn.setScalar(0), wn.setScalar(0), Sn.fromBufferAttribute(e, t), Cn.fromBufferAttribute(e, n), wn.fromBufferAttribute(e, r), a.setScalar(0), a.addScaledVector(Sn, i.x), a.addScaledVector(Cn, i.y), a.addScaledVector(wn, i.z), a;
	}
	static isFrontFacing(e, t, n, r) {
		return fn.subVectors(n, t), pn.subVectors(e, t), fn.cross(pn).dot(r) < 0;
	}
	set(e, t, n) {
	...
	getArea() {
		return fn.subVectors(this.c, this.b), pn.subVectors(this.a, this.b), fn.cross(pn).length() * .5;
	}
	getMidpoint(e) {
	...
	closestPointToPoint(e, t) {
		...
		gn.subVectors(r, n), _n.subVectors(i, n), yn.subVectors(e, n);
		let s = gn.dot(yn), c = _n.dot(yn);
		if (s <= 0 && c <= 0) return t.copy(n);
		bn.subVectors(e, r);
		let l = gn.dot(bn), u = _n.dot(bn);
		if (l >= 0 && u <= l) return t.copy(r);
		let d = s * u - l * c;
		if (d <= 0 && s >= 0 && l <= 0) return a = s / (s - l), t.copy(n).addScaledVector(gn, a);
		xn.subVectors(e, i);
		let f = gn.dot(xn), p = _n.dot(xn);
		if (p >= 0 && f <= p) return t.copy(i);
		let m = f * c - s * p;
		if (m <= 0 && c >= 0 && p <= 0) return o = c / (c - p), t.copy(n).addScaledVector(_n, o);
		let h = l * p - f * u;
		if (h <= 0 && u - l >= 0 && f - p >= 0) return vn.subVectors(i, r), o = (u - l) / (u - l + (f - p)), t.copy(r).addScaledVector(vn, o);
		let g = 1 / (h + m + d);
		return a = m * g, o = d * g, t.copy(n).addScaledVector(gn, a).addScaledVector(_n, o);
	}
	equals(e) {
	...
	setFromCenterAndSize(e, t) {
		let n = On.copy(t).multiplyScalar(.5);
	...
	expandByObject(e, t = !1) {
		...
		if (n !== void 0) {
			...
			if (t === !0 && r !== void 0 && e.isInstancedMesh !== !0) for (let t = 0, n = r.count; t < n; t++) e.isMesh === !0 ? e.getVertexPosition(t, On) : On.fromBufferAttribute(r, t), On.applyMatrix4(e.matrixWorld), this.expandByPoint(On);
			else e.boundingBox === void 0 ? (n.boundingBox === null && n.computeBoundingBox(), kn.copy(n.boundingBox)) : (e.boundingBox === null && e.computeBoundingBox(), kn.copy(e.boundingBox)), kn.applyMatrix4(e.matrixWorld), this.union(kn);
		}
		let r = e.children;
	...
	intersectsTriangle(e) {
		...
		this.getCenter(In), Ln.subVectors(this.max, In), An.subVectors(e.a, In), jn.subVectors(e.b, In), Mn.subVectors(e.c, In), Nn.subVectors(jn, An), Pn.subVectors(Mn, jn), Fn.subVectors(An, Mn);
		let t = [
			0,
			-Nn.z,
			Nn.y,
		...
		return !Bn(t, An, jn, Mn, Ln) || (t = [
			...
			0,
			1
		], !Bn(t, An, jn, Mn, Ln)) ? !1 : (Rn.crossVectors(Nn, Pn), t = [
			Rn.x,
			Rn.y,
			Rn.z
		], Bn(t, An, jn, Mn, Ln));
	...
	/* @__PURE__ */ new J(),
	/* @__PURE__ */ new J()
], On = /* @__PURE__ */ new J(), kn = /* @__PURE__ */ new En(), An = /* @__PURE__ */ new J(), jn = /* @__PURE__ */ new J(), Mn = /* @__PURE__ */ new J(), Nn = /* @__PURE__ */ new J(), Pn = /* @__PURE__ */ new J(), Fn = /* @__PURE__ */ new J(), In = /* @__PURE__ */ new J(), Ln = /* @__PURE__ */ new J(), Rn = /* @__PURE__ */ new J(), zn = /* @__PURE__ */ new J();
...
var Vn = /* @__PURE__ */ new J(), Hn = /* @__PURE__ */ new q(), Un = 0, Wn = class extends Xe {
	constructor(e, t, n = !1) {
		if (super(), Array.isArray(e)) throw TypeError("THREE.BufferAttribute: array should be a Typed Array.");
		this.isBufferAttribute = !0, Object.defineProperty(this, "id", { value: Un++ }), this.name = "", this.array = e, this.itemSize = t, this.count = e === void 0 ? 0 : e.length / t, this.normalized = n, this.usage = Le, this.updateRanges = [], this.gpuType = h, this.version = 0;
	}
	onUploadCallback() {}
	set needsUpdate(e) {
		e === !0 && this.version++;
	...
	applyMatrix3(e) {
		...
		else if (this.itemSize === 3) for (let t = 0, n = this.count; t < n; t++) Vn.fromBufferAttribute(this, t), Vn.applyMatrix3(e), this.setXYZ(t, Vn.x, Vn.y, Vn.z);
		return this;
	}
	applyMatrix4(e) {
		for (let t = 0, n = this.count; t < n; t++) Vn.fromBufferAttribute(this, t), Vn.applyMatrix4(e), this.setXYZ(t, Vn.x, Vn.y, Vn.z);
		return this;
	}
	applyNormalMatrix(e) {
	...
	setXYZW(e, t, n, r, i) {
		return e *= this.itemSize, this.normalized && (t = it(t, this.array), n = it(n, this.array), r = it(r, this.array), i = it(i, this.array)), this.array[e + 0] = t, this.array[e + 1] = n, this.array[e + 2] = r, this.array[e + 3] = i, this;
	}
	onUpload(e) {
...
}, Jn = /* @__PURE__ */ new En(), Yn = /* @__PURE__ */ new J(), Xn = /* @__PURE__ */ new J(), Zn = class {
	...
	setFromPoints(e, t) {
		let n = this.center;
		t === void 0 ? Jn.setFromPoints(e).getCenter(n) : n.copy(t);
		let r = 0;
	...
	expandByPoint(e) {
		...
		if (t > this.radius * this.radius) {
			...
			this.center.addScaledVector(Yn, n / e), this.radius += n;
		}
		return this;
	}
	union(e) {
		return e.isEmpty() ? this : this.isEmpty() ? (this.copy(e), this) : (this.center.equals(e.center) === !0 ? this.radius = Math.max(this.radius, e.radius) : (Xn.subVectors(e.center, this.center).setLength(e.radius), this.expandByPoint(Yn.copy(e.center).add(Xn)), this.expandByPoint(Yn.copy(e.center).sub(Xn))), this);
	}
	equals(e) {
...
}, Qn = 0, $n = /* @__PURE__ */ new Dt(), er = /* @__PURE__ */ new en(), tr = /* @__PURE__ */ new J(), nr = /* @__PURE__ */ new En(), rr = /* @__PURE__ */ new En(), ir = /* @__PURE__ */ new J(), ar = class e extends Xe {
	constructor() {
		super(), this.isBufferGeometry = !0, Object.defineProperty(this, "id", { value: Qn++ }), this.uuid = et(), this.name = "", this.type = "BufferGeometry", this.index = null, this.indirect = null, this.indirectOffset = 0, this.attributes = {}, this.morphAttributes = {}, this.morphTargetsRelative = !1, this.groups = [], this.boundingBox = null, this.boundingSphere = null, this.drawRange = {
			start: 0,
			count: Infinity
		}, this.userData = {};
	}
	...
	setIndex(e) {
		return Array.isArray(e) ? this.index = new (ze(e) ? Kn : Gn)(e, 1) : this.index = e, this;
	}
	setIndirect(e, t = 0) {
	...
	computeBoundingBox() {
		...
		if (e !== void 0) {
			if (this.boundingBox.setFromBufferAttribute(e), t) for (let e = 0, n = t.length; e < n; e++) {
				let n = t[e];
				nr.setFromBufferAttribute(n), this.morphTargetsRelative ? (ir.addVectors(this.boundingBox.min, nr.min), this.boundingBox.expandByPoint(ir), ir.addVectors(this.boundingBox.max, nr.max), this.boundingBox.expandByPoint(ir)) : (this.boundingBox.expandByPoint(nr.min), this.boundingBox.expandByPoint(nr.max));
			}
	...
	computeBoundingSphere() {
		...
		if (e) {
			...
			if (nr.setFromBufferAttribute(e), t) for (let e = 0, n = t.length; e < n; e++) {
				let n = t[e];
				rr.setFromBufferAttribute(n), this.morphTargetsRelative ? (ir.addVectors(nr.min, rr.min), nr.expandByPoint(ir), ir.addVectors(nr.max, rr.max), nr.expandByPoint(ir)) : (nr.expandByPoint(rr.min), nr.expandByPoint(rr.max));
			}
			nr.getCenter(n);
			let r = 0;
			...
			if (t) for (let i = 0, a = t.length; i < a; i++) {
				...
				for (let t = 0, i = a.count; t < i; t++) ir.fromBufferAttribute(a, t), o && (tr.fromBufferAttribute(e, t), ir.add(tr)), r = Math.max(r, n.distanceToSquared(ir));
			}
	...
	computeVertexNormals() {
		...
		if (t !== void 0) {
			...
			if (n === void 0) n = new Wn(new Float32Array(t.count * 3), 3), this.setAttribute("normal", n);
...
}, or = 0, sr = class extends Xe {
	constructor() {
		super(), this.isMaterial = !0, Object.defineProperty(this, "id", { value: or++ }), this.uuid = et(), this.name = "", this.type = "Material", this.blending = 1, this.side = 0, this.vertexColors = !1, this.opacity = 1, this.transparent = !1, this.alphaHash = !1, this.blendSrc = 204, this.blendDst = 205, this.blendEquation = 100, this.blendSrcAlpha = null, this.blendDstAlpha = null, this.blendEquationAlpha = null, this.blendColor = new Z(0, 0, 0), this.blendAlpha = 0, this.depthFunc = 3, this.depthTest = !0, this.depthWrite = !0, this.stencilWriteMask = 255, this.stencilFunc = 519, this.stencilRef = 0, this.stencilFuncMask = 255, this.stencilFail = Ie, this.stencilZFail = Ie, this.stencilZPass = Ie, this.stencilWrite = !1, this.clippingPlanes = null, this.clipIntersection = !1, this.clipShadows = !1, this.shadowSide = null, this.colorWrite = !0, this.precision = null, this.polygonOffset = !1, this.polygonOffsetFactor = 0, this.polygonOffsetUnits = 0, this.dithering = !1, this.alphaToCoverage = !1, this.premultipliedAlpha = !1, this.forceSinglePass = !1, this.allowOverride = !0, this.visible = !0, this.toneMapped = !0, this.userData = {}, this.version = 0, this._alphaTest = 0;
	}
	get alphaTest() {
...
}, cr = /* @__PURE__ */ new J(), lr = /* @__PURE__ */ new J(), ur = /* @__PURE__ */ new J(), dr = /* @__PURE__ */ new J(), fr = /* @__PURE__ */ new J(), pr = /* @__PURE__ */ new J(), mr = /* @__PURE__ */ new J(), hr = class {
	...
	distanceSqToSegment(e, t, n, r) {
		lr.copy(e).add(t).multiplyScalar(.5), ur.copy(t).sub(e).normalize(), dr.copy(this.origin).sub(lr);
		let i = e.distanceTo(t) * .5, a = -this.direction.dot(ur), o = dr.dot(this.direction), s = -dr.dot(ur), c = dr.lengthSq(), l = Math.abs(1 - a * a), u, d, f, p;
		...
		return n && n.copy(this.origin).addScaledVector(this.direction, u), r && r.copy(lr).addScaledVector(ur, d), f;
	}
	intersectSphere(e, t) {
	...
	intersectTriangle(e, t, n, r, i) {
		fr.subVectors(t, e), pr.subVectors(n, e), mr.crossVectors(fr, pr);
		...
		let s = o * this.direction.dot(pr.crossVectors(dr, pr));
		if (s < 0) return null;
		let c = o * this.direction.dot(fr.cross(dr));
...
}, _r = /* @__PURE__ */ new Dt(), vr = /* @__PURE__ */ new hr(), yr = /* @__PURE__ */ new Zn(), br = /* @__PURE__ */ new J(), xr = /* @__PURE__ */ new J(), Sr = /* @__PURE__ */ new J(), Cr = /* @__PURE__ */ new J(), wr = /* @__PURE__ */ new J(), Tr = /* @__PURE__ */ new J(), Er = /* @__PURE__ */ new J(), Dr = /* @__PURE__ */ new J(), Or = class extends en {
	constructor(e = new ar(), t = new gr()) {
	...
	getVertexPosition(e, t) {
		...
		if (i && o) {
			...
			for (let n = 0, r = i.length; n < r; n++) {
				let r = o[n], s = i[n];
				r !== 0 && (wr.fromBufferAttribute(s, e), a ? Tr.addScaledVector(wr, r) : Tr.addScaledVector(wr.sub(t), r));
			}
			t.add(Tr);
		}
		return t;
	...
	raycast(e, t) {
		...
		r !== void 0 && (n.boundingSphere === null && n.computeBoundingSphere(), yr.copy(n.boundingSphere), yr.applyMatrix4(i), vr.copy(e.ray).recast(e.near), !(yr.containsPoint(vr.origin) === !1 && (vr.intersectSphere(yr, br) === null || vr.origin.distanceToSquared(br) > (e.far - e.near) ** 2)) && (_r.copy(i).invert(), vr.copy(e.ray).applyMatrix4(_r), !(n.boundingBox !== null && vr.intersectsBox(n.boundingBox) === !1) && this._computeIntersections(e, t, vr)));
	}
	_computeIntersections(e, t, n) {
		...
		if (o !== null) if (Array.isArray(a)) for (let i = 0, s = d.length; i < s; i++) {
			...
			for (let i = m, a = h; i < a; i += 3) {
				...
				r = Ar(this, p, e, n, c, l, u, a, d, f), r && (r.faceIndex = Math.floor(i / 3), r.face.materialIndex = s.materialIndex, t.push(r));
			}
		}
		else {
			...
			for (let d = i, f = s; d < f; d += 3) {
				...
				r = Ar(this, a, e, n, c, l, u, i, s, f), r && (r.faceIndex = Math.floor(d / 3), t.push(r));
			}
		}
			...
			for (let i = m, a = h; i < a; i += 3) {
				let a = i, s = i + 1, d = i + 2;
				r = Ar(this, p, e, n, c, l, u, a, s, d), r && (r.faceIndex = Math.floor(i / 3), r.face.materialIndex = o.materialIndex, t.push(r));
			}
		}
		else {
			...
			for (let s = i, d = o; s < d; s += 3) {
				let i = s, o = s + 1, d = s + 2;
				r = Ar(this, a, e, n, c, l, u, i, o, d), r && (r.faceIndex = Math.floor(s / 3), t.push(r));
			}
		}
	}
};
function kr(e, t, n, r, i, a, o, s) {
	...
	Dr.copy(s), Dr.applyMatrix4(e.matrixWorld);
	let l = n.ray.origin.distanceTo(Dr);
...
function Ar(e, t, n, r, i, a, o, s, c, l) {
	e.getVertexPosition(s, xr), e.getVertexPosition(c, Sr), e.getVertexPosition(l, Cr);
	let u = kr(e, t, n, r, xr, Sr, Cr, Er);
	if (u) {
		let e = new J();
		Tn.getBarycoord(Er, xr, Sr, Cr, e), i && (u.uv = Tn.getInterpolatedAttribute(i, s, c, l, e, new q())), a && (u.uv1 = Tn.getInterpolatedAttribute(a, s, c, l, e, new q())), o && (u.normal = Tn.getInterpolatedAttribute(o, s, c, l, e, new J()), u.normal.dot(r.direction) > 0 && u.normal.multiplyScalar(-1));
		let t = {
			a: s,
			b: c,
			c: l,
		...
		Tn.getNormal(xr, Sr, Cr, t.normal), u.face = t, u.barycoord = e;
	}
	return u;
}
var jr = class extends xt {
...
}, Mr = /* @__PURE__ */ new J(), Nr = /* @__PURE__ */ new J(), Pr = /* @__PURE__ */ new Y(), Fr = class {
	...
	setFromCoplanarPoints(e, t, n) {
		let r = Mr.subVectors(n, t).cross(Nr.subVectors(e, t)).normalize();
	...
	intersectLine(e, t, n = !0) {
		let r = e.delta(Mr), i = this.normal.dot(r);
	...
	applyMatrix4(e, t) {
		let n = t || Pr.getNormalMatrix(e), r = this.coplanarPoint(Mr).applyMatrix4(e), i = this.normal.applyMatrix3(n).normalize();
...
}, Ir = /* @__PURE__ */ new Zn(), Lr = /* @__PURE__ */ new q(.5, .5), Rr = /* @__PURE__ */ new J(), zr = class {
	constructor(e = new Fr(), t = new Fr(), n = new Fr(), r = new Fr(), i = new Fr(), a = new Fr()) {
		this.planes = [
			e,
			t,
			n,
	...
	intersectsSprite(e) {
		return Ir.center.set(0, 0, 0), Ir.radius = .7071067811865476 + Lr.distanceTo(e.center), Ir.applyMatrix4(e.matrixWorld), this.intersectsSphere(Ir);
	}
	intersectsSphere(e) {
	...
	intersectsBox(e) {
		...
		for (let n = 0; n < 6; n++) {
			let r = t[n];
			if (Rr.x = r.normal.x > 0 ? e.max.x : e.min.x, Rr.y = r.normal.y > 0 ? e.max.y : e.min.y, Rr.z = r.normal.z > 0 ? e.max.z : e.min.z, r.distanceToPoint(Rr) < 0) return !1;
		}
		return !0;
	}
	containsPoint(e) {
	...
	copy(e) {
		return super.copy(e), this.source = new _t(Object.assign({}, e.image)), this.compareFunction = e.compareFunction, this;
	}
	toJSON(e) {
		let t = super.toJSON(e);
	...
	constructor(e = 1, t = 1, n = 1, r = 1, i = 1, a = 1) {
		...
		let s = [], c = [], l = [], u = [], d = 0, f = 0;
		p("z", "y", "x", -1, -1, n, t, e, a, i, 0), p("z", "y", "x", 1, -1, n, t, -e, a, i, 1), p("x", "z", "y", 1, 1, e, n, t, r, a, 2), p("x", "z", "y", 1, -1, e, n, -t, r, a, 3), p("x", "y", "z", 1, -1, e, t, n, r, i, 4), p("x", "y", "z", -1, -1, e, t, -n, r, i, 5), this.setIndex(s), this.setAttribute("position", new qn(c, 3)), this.setAttribute("normal", new qn(l, 3)), this.setAttribute("uv", new qn(u, 2));
	...
	constructor(e = 1, t = 1, n = 1, r = 1) {
		...
		this.setIndex(f), this.setAttribute("position", new qn(p, 3)), this.setAttribute("normal", new qn(m, 3)), this.setAttribute("uv", new qn(h, 2));
	}
	copy(e) {
		return super.copy(e), this.parameters = Object.assign({}, e.parameters), this;
	}
...
function qr(e) {
	...
	for (let n in e) {
		...
		for (let r in e[n]) {
			let i = e[n][r];
			if (Yr(i)) i.isRenderTargetTexture ? (W("UniformsUtils: Textures of render targets cannot be cloned via cloneUniforms() or mergeUniforms()."), t[n][r] = null) : t[n][r] = i.clone();
			else if (Array.isArray(i)) if (Yr(i[0])) {
				let e = [];
...
fi.prototype.ValueTypeName = "", fi.prototype.TimeBufferType = Float32Array, fi.prototype.ValueBufferType = Float32Array, fi.prototype.DefaultInterpolation = Oe;
var pi = class extends fi {
	constructor(e, t, n) {
		super(e, t, n);
	}
};
pi.prototype.ValueTypeName = "bool", pi.prototype.ValueBufferType = Array, pi.prototype.DefaultInterpolation = B, pi.prototype.InterpolantFactoryMethodLinear = void 0, pi.prototype.InterpolantFactoryMethodSmooth = void 0;
...
vi.prototype.ValueTypeName = "string", vi.prototype.ValueBufferType = Array, vi.prototype.DefaultInterpolation = B, vi.prototype.InterpolantFactoryMethodLinear = void 0, vi.prototype.InterpolantFactoryMethodSmooth = void 0;
...
var Si = class extends en {
	...
	constructor(e, t, n) {
		super(e, n), this.isHemisphereLight = !0, this.type = "HemisphereLight", this.position.copy(en.DEFAULT_UP), this.updateMatrix(), this.groundColor = new Z(t);
	}
	copy(e, t) {
...
}, wi = /* @__PURE__ */ new Dt(), Ti = /* @__PURE__ */ new J(), Ei = /* @__PURE__ */ new J(), Di = class {
	constructor(e) {
		this.camera = e, this.intensity = 1, this.bias = 0, this.biasNode = null, this.normalBias = 0, this.radius = 1, this.blurSamples = 8, this.mapSize = new q(512, 512), this.mapType = l, this.map = null, this.mapPass = null, this.matrix = new Dt(), this.autoUpdate = !0, this.needsUpdate = !1, this._frustum = new zr(), this._frameExtents = new q(1, 1), this._viewportCount = 1, this._viewports = [new St(0, 0, 1, 1)];
	}
	getViewportCount() {
	...
	updateMatrices(e) {
		...
		Ti.setFromMatrixPosition(e.matrixWorld), t.position.copy(Ti), Ei.setFromMatrixPosition(e.target.matrixWorld), t.lookAt(Ei), t.updateMatrixWorld(), wi.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), this._frustum.setFromProjectionMatrix(wi, t.coordinateSystem, t.reversedDepth), t.coordinateSystem === 2001 || t.reversedDepth ? n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, 1, 0, 0, 0, 0, 1) : n.set(.5, 0, 0, .5, 0, .5, 0, .5, 0, 0, .5, .5, 0, 0, 0, 1), n.multiply(wi);
	}
	getViewport(e) {
...
}, Oi = /* @__PURE__ */ new J(), ki = /* @__PURE__ */ new at(), Ai = /* @__PURE__ */ new J(), ji = class extends en {
	constructor() {
		super(), this.isCamera = !0, this.type = "Camera", this.matrixWorldInverse = new Dt(), this.projectionMatrix = new Dt(), this.projectionMatrixInverse = new Dt(), this.coordinateSystem = Re, this._reversedDepth = !1;
	}
	get reversedDepth() {
	...
	updateMatrixWorld(e) {
		super.updateMatrixWorld(e), this.matrixWorld.decompose(Oi, ki, Ai), Ai.x === 1 && Ai.y === 1 && Ai.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(Oi, ki, Ai.set(1, 1, 1)).invert();
	}
	updateWorldMatrix(e, t) {
		super.updateWorldMatrix(e, t), this.matrixWorld.decompose(Oi, ki, Ai), Ai.x === 1 && Ai.y === 1 && Ai.z === 1 ? this.matrixWorldInverse.copy(this.matrixWorld).invert() : this.matrixWorldInverse.compose(Oi, ki, Ai.set(1, 1, 1)).invert();
	}
	clone() {
		return new this.constructor().copy(this);
	}
}, Mi = /* @__PURE__ */ new J(), Ni = /* @__PURE__ */ new q(), Pi = /* @__PURE__ */ new q(), Fi = class extends ji {
	...
	setFocalLength(e) {
		...
		this.fov = $e * 2 * Math.atan(t), this.updateProjectionMatrix();
	}
	getFocalLength() {
		let e = Math.tan(Qe * .5 * this.fov);
		return .5 * this.getFilmHeight() / e;
	}
	getEffectiveFOV() {
		return $e * 2 * Math.atan(Math.tan(Qe * .5 * this.fov) / this.zoom);
	}
	getFilmWidth() {
	...
	getViewBounds(e, t, n) {
		Mi.set(-1, -1, .5).applyMatrix4(this.projectionMatrixInverse), t.set(Mi.x, Mi.y).multiplyScalar(-e / Mi.z), Mi.set(1, 1, .5).applyMatrix4(this.projectionMatrixInverse), n.set(Mi.x, Mi.y).multiplyScalar(-e / Mi.z);
	}
	getViewSize(e, t) {
		return this.getViewBounds(e, Ni, Pi), t.subVectors(Pi, Ni);
	}
	...
	updateProjectionMatrix() {
		let e = this.near, t = e * Math.tan(Qe * .5 * this.fov) / this.zoom, n = 2 * t, r = this.aspect * n, i = -.5 * r, a = this.view;
	...
	constructor() {
		super(new Fi(90, 1, .5, 500)), this.isPointLightShadow = !0;
	}
}, Li = class extends Si {
	...
	constructor(e, t) {
		super(e, t), this.isDirectionalLight = !0, this.type = "DirectionalLight", this.position.copy(en.DEFAULT_UP), this.updateMatrix(), this.target = new en(), this.shadow = new zi();
	}
	dispose() {
		super.dispose(), this.shadow.dispose();
	}
...
}, Vi = -90, Hi = 1, Ui = class extends en {
	constructor(e, t, n) {
		super(), this.type = "CubeCamera", this.renderTarget = n, this.coordinateSystem = null, this.activeMipmapLevel = 0;
		let r = new Fi(Vi, Hi, e, t);
		r.layers = this.layers, this.add(r);
		let i = new Fi(Vi, Hi, e, t);
		i.layers = this.layers, this.add(i);
		let a = new Fi(Vi, Hi, e, t);
		a.layers = this.layers, this.add(a);
		let o = new Fi(Vi, Hi, e, t);
		o.layers = this.layers, this.add(o);
		let s = new Fi(Vi, Hi, e, t);
		s.layers = this.layers, this.add(s);
		let c = new Fi(Vi, Hi, e, t);
...
}, Gi = "\\[\\]\\.:\\/", Ki = RegExp("[" + Gi + "]", "g"), qi = "[^" + Gi + "]", Ji = "[^" + Gi.replace("\\.", "") + "]", Yi = /* @__PURE__ */ "((?:WC+[\\/:])*)".replace("WC", qi), Xi = /* @__PURE__ */ "(WCOD+)?".replace("WCOD", Ji), Zi = /* @__PURE__ */ "(?:\\.(WC+)(?:\\[(.+)\\])?)?".replace("WC", qi), Qi = /* @__PURE__ */ "\\.(WC+)(?:\\[(.+)\\])?".replace("WC", qi), $i = RegExp("^" + Yi + Xi + Zi + Qi + "$"), ea = [
	"material",
	"materials",
	"bones",
	"map"
...
var ra = class {
	constructor(e = !0) {
		this.autoStart = e, this.startTime = 0, this.oldTime = 0, this.elapsedTime = 0, this.running = !1, W("Clock: This module has been deprecated. Please use THREE.Timer instead.");
	}
	start() {
...
function ia(e, t, n, r) {
	...
	switch (n) {
		...
		case R: return Math.floor((e + 5) / 6) * Math.floor((t + 5) / 6) * 16;
...
var Q = {
	...
	points: {
		uniforms: /* @__PURE__ */ Jr([$.points, $.fog]),
	...
	depth: {
		uniforms: /* @__PURE__ */ Jr([$.common, $.displacementmap]),
	...
	sprite: {
		uniforms: /* @__PURE__ */ Jr([$.sprite, $.fog]),
...
ca.physical = {
	uniforms: /* @__PURE__ */ Jr([ca.standard.uniforms, {
		clearcoat: { value: 0 },
...
var la = {
	...
	b: 0,
	g: 0
}, ua = /* @__PURE__ */ new Dt(), da = /* @__PURE__ */ new Y();
...
function fa(e, t, n, r, i, a) {
	...
	function h(t, n) {
		let i = p(n);
		i && (i.isCubeTexture || i.mapping === 306) ? (l === void 0 && (l = new Or(new Wr(1, 1, 1), new ti({
			name: "BackgroundCubeMaterial",
			uniforms: qr(ca.backgroundCube.uniforms),
	...
	function g(t, r) {
		t.getRGB(la, Zr(e)), n.buffers.color.setClear(la.r, la.g, la.b, r, a);
	}
	function _() {
...
function ga(e) {
	let t = this, n = null, r = 0, i = !1, a = !1, o = new Fr(), s = new Y(), c = {
		value: null,
		needsUpdate: !1
	};
...
var _a = 4, va = [
	...
	.526,
	.582
], ya = 20, ba = 256, xa = /* @__PURE__ */ new Ri(), Sa = /* @__PURE__ */ new Z(), Ca = null, wa = 0, Ta = 0, Ea = !1, Da = /* @__PURE__ */ new J(), Oa = class {
	constructor(e) {
		this._renderer = e, this._pingPongRenderTarget = null, this._lodMax = 0, this._cubeSize = 0, this._sizeLods = [], this._sigmas = [], this._lodMeshes = [], this._backgroundBox = null, this._cubemapMaterial = null, this._equirectMaterial = null, this._blurMaterial = null, this._ggxMaterial = null;
	}
	fromScene(e, t = 0, n = .1, r = 100, i = {}) {
		let { size: a = 256, position: o = Da } = i;
		Ca = this._renderer.getRenderTarget(), wa = this._renderer.getActiveCubeFace(), Ta = this._renderer.getActiveMipmapLevel(), Ea = this._renderer.xr.enabled, this._renderer.xr.enabled = !1, this._setSize(a);
	...
	_cleanup(e) {
		this._renderer.setRenderTarget(Ca, wa, Ta), this._renderer.xr.enabled = Ea, e.scissorTest = !1, ja(e, 0, 0, e.width, e.height);
	}
	_fromTexture(e, t) {
		e.mapping === 301 || e.mapping === 302 ? this._setSize(e.image.length === 0 ? 16 : e.image[0].width || e.image[0].image.width) : this._setSize(e.image.width / 4), Ca = this._renderer.getRenderTarget(), wa = this._renderer.getActiveCubeFace(), Ta = this._renderer.getActiveMipmapLevel(), Ea = this._renderer.xr.enabled, this._renderer.xr.enabled = !1;
	...
	_allocateTargets() {
		...
		if (this._pingPongRenderTarget === null || this._pingPongRenderTarget.width !== e || this._pingPongRenderTarget.height !== t) {
			...
			let { _lodMax: r } = this;
			({lodMeshes: this._lodMeshes, sizeLods: this._sizeLods, sigmas: this._sigmas} = ka(r)), this._blurMaterial = Na(r, e, t), this._ggxMaterial = Ma(r, e, t);
		}
		return r;
	}
	_compileMaterial(e) {
		let t = new Or(new ar(), e);
		this._renderer.compile(t, xa);
	}
	_sceneToCubeUV(e, t, n, r, i) {
		let a = new Fi(90, 1, t, n), o = [
			1,
			-1,
			1,
			1,
		...
		c.getClearColor(Sa), c.toneMapping = 0, c.autoClear = !1, c.state.buffers.depth.getReversed() && (c.setRenderTarget(r), c.clearDepth(), c.setRenderTarget(null)), this._backgroundBox === null && (this._backgroundBox = new Or(new Wr(), new gr({
		...
		m ? m.isColor && (f.color.copy(m), e.background = null, p = !0) : (f.color.copy(Sa), p = !0);
		for (let t = 0; t < 6; t++) {
			let n = t % 3;
			...
			ja(r, n * l, t > 2 ? l : 0, l, l), c.setRenderTarget(r), p && c.render(d, a), c.render(e, a);
		}
		c.toneMapping = u, c.autoClear = l, e.background = m;
	}
	_textureToCubeUV(e, t) {
		let n = this._renderer, r = e.mapping === 301 || e.mapping === 302;
		r ? (this._cubemapMaterial === null && (this._cubemapMaterial = Fa()), this._cubemapMaterial.uniforms.flipEnvMap.value = e.isRenderTargetTexture === !1 ? -1 : 1) : this._equirectMaterial === null && (this._equirectMaterial = Pa());
		let i = r ? this._cubemapMaterial : this._equirectMaterial, a = this._lodMeshes[0];
		a.material = i;
		let o = i.uniforms;
		o.envMap.value = e;
		let s = this._cubeSize;
		ja(t, 0, 0, 3 * s, 2 * s), n.setRenderTarget(t), n.render(a, xa);
	}
	_applyPMREM(e) {
	...
	_applyGGXFilter(e, t, n) {
		...
		o.material = a;
		let s = a.uniforms, c = n / (this._lodMeshes.length - 1), l = t / (this._lodMeshes.length - 1), u = Math.sqrt(c * c - l * l) * (0 + c * 1.25), { _lodMax: d } = this, f = this._sizeLods[n], p = 3 * f * (n > d - _a ? n - d + _a : 0), m = 4 * (this._cubeSize - f);
		s.envMap.value = e.texture, s.roughness.value = u, s.mipInt.value = d - t, ja(i, p, m, 3 * f, 2 * f), r.setRenderTarget(i), r.render(o, xa), s.envMap.value = i.texture, s.roughness.value = 0, s.mipInt.value = d - n, ja(e, p, m, 3 * f, 2 * f), r.setRenderTarget(e), r.render(o, xa);
	}
	_blur(e, t, n, r, i) {
	...
	_halfBlur(e, t, n, r, i, a, o) {
		...
		l.material = c;
		let u = c.uniforms, d = this._sizeLods[n] - 1, f = isFinite(i) ? Math.PI / (2 * d) : 2 * Math.PI / (2 * ya - 1), p = i / f, m = isFinite(i) ? 1 + Math.floor(3 * p) : ya;
		m > ya && W(`sigmaRadians, ${i}, is too large and will clip, as it requested ${m} samples when the maximum is set to ${ya}`);
		let h = [], g = 0;
		for (let e = 0; e < ya; ++e) {
		...
		ja(t, 3 * v * (r > _ - _a ? r - _ + _a : 0), 4 * (this._cubeSize - v), 3 * v, 2 * v), s.setRenderTarget(t), s.render(l, xa);
	}
};
function ka(e) {
	let t = [], n = [], r = [], i = e, a = e - _a + 1 + va.length;
	for (let o = 0; o < a; o++) {
		let a = 2 ** i;
		t.push(a);
		let s = 1 / a;
		o > e - _a ? s = va[o - e + _a - 1] : o === 0 && (s = 0), n.push(s);
		...
		let h = new ar();
		h.setAttribute("position", new Wn(f, 3)), h.setAttribute("uv", new Wn(p, 2)), h.setAttribute("faceIndex", new Wn(m, 1)), r.push(new Or(h, null)), i > _a && i--;
	}
	return {
		lodMeshes: r,
		sizeLods: t,
...
function Na(e, t, n) {
	let r = new Float32Array(ya), i = new J(0, 1, 0);
	return new ti({
...
var La = class extends wt {
	constructor(e = 1, t = {}) {
		...
		this.texture = new Br(r), this._setTextureOptions(t), this.texture.isRenderTargetTexture = !0;
	}
	fromEquirectangularTexture(e, t) {
		...
		let a = new Or(r, i), s = t.minFilter;
		return t.minFilter === 1008 && (t.minFilter = o), new Ui(1, 10, this).update(e, a), t.minFilter = s, a.geometry.dispose(), a.material.dispose(), this;
	}
	clear(e, t = !0, n = !0, r = !0) {
	...
	function o(t) {
		if (t && t.isTexture) {
			...
			if (a || o) {
				...
				if (t.isRenderTargetTexture && t.pmremVersion !== s) return r === null && (r = new Oa(e)), i = a ? r.fromEquirectangular(t, i) : r.fromCubemap(t, i), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), i.texture;
				if (i !== void 0) return i.texture;
				{
					let s = t.image;
					return a && s && s.height > 0 || o && s && c(s) ? (r === null && (r = new Oa(e)), i = a ? r.fromEquirectangular(t) : r.fromCubemap(t), i.texture.pmremVersion = t.pmremVersion, n.set(t, i), t.addEventListener("dispose", u), i.texture) : null;
				}
			}
		}
		return t;
...
function Ba(e, t, n, r) {
	...
	function l(e) {
		...
		let s = new (i.count >= 65535 ? Kn : Gn)(n, 1);
		s.version = o;
		let c = a.get(e);
...
function Ua(e, t, n) {
	let r = /* @__PURE__ */ new WeakMap(), i = new St();
	function a(a, o, s) {
		...
		if (d === void 0 || d.count !== u) {
			...
			let g = new Float32Array(p * m * 4 * u), _ = new Tt(g, p, m, u);
...
function Ka(e, t, n, r, i) {
	let a = new wt(t, n, {
		...
		depthBuffer: r,
		stencilBuffer: i,
		depthTexture: r ? new Vr(t, n) : void 0
	}), o = new wt(t, n, {
		type: g,
		depthBuffer: !1,
		stencilBuffer: !1
	}), s = new ar();
	s.setAttribute("position", new qn([
		-1,
		3,
		0,
		-1,
	...
	let c = new ni({
		...
		depthTest: !1,
		depthWrite: !1
	}), l = new Or(s, c), u = new Ri(-1, 1, 1, -1, 0, 1), d = null, f = null, p = !1, m, h = null, _ = [], v = !1;
...
var qa = /* @__PURE__ */ new xt(), Ja = /* @__PURE__ */ new Vr(1, 1), Ya = /* @__PURE__ */ new Tt(), Xa = /* @__PURE__ */ new Et(), Za = /* @__PURE__ */ new Br(), Qa = [], $a = [], eo = new Float32Array(16), to = new Float32Array(9), no = new Float32Array(4);
function ro(e, t, n) {
	let r = e[0];
	if (r <= 0 || r > 0) return e;
	let i = t * n, a = Qa[i];
	if (a === void 0 && (a = new Float32Array(i), Qa[i] = a), t !== 0) {
		r.toArray(a, 0);
...
function oo(e, t) {
	let n = $a[t];
	n === void 0 && (n = new Int32Array(t), $a[t] = n);
...
function fo(e, t) {
	...
	if (r === void 0) {
		...
		if (io(n, r)) return;
		no.set(r), e.uniformMatrix2fv(this.addr, !1, no), ao(n, r);
	}
}
function po(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (io(n, r)) return;
		to.set(r), e.uniformMatrix3fv(this.addr, !1, to), ao(n, r);
	}
}
function mo(e, t) {
	let n = this.cache, r = t.elements;
	if (r === void 0) {
		...
		if (io(n, r)) return;
		eo.set(r), e.uniformMatrix4fv(this.addr, !1, eo), ao(n, r);
	}
}
function ho(e, t) {
	let n = this.cache;
...
function Co(e, t, n) {
	...
	let a;
	this.type === e.SAMPLER_2D_SHADOW ? (Ja.compareFunction = n.isReversedDepthBuffer() ? 518 : 515, a = Ja) : a = qa, n.setTexture2D(t || a, i);
}
function wo(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture3D(t || Xa, i);
}
function To(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTextureCube(t || Za, i);
}
function Eo(e, t, n) {
	let r = this.cache, i = n.allocateTextureUnit();
	r[0] !== i && (e.uniform1i(this.addr, i), r[0] = i), n.setTexture2DArray(t || Ya, i);
}
function Do(e) {
	switch (e) {
		case 5126: return so;
		...
		case 35666: return uo;
		case 35674: return fo;
		case 35675: return po;
		case 35676: return mo;
		case 5124:
		case 35670: return ho;
		case 35667:
		case 35671: return go;
		case 35668:
		case 35672: return _o;
		case 35669:
		case 35673: return vo;
		case 5125: return yo;
		case 36294: return bo;
		case 36295: return xo;
		case 36296: return So;
		case 35678:
		case 36198:
		case 36298:
		case 36306:
		case 35682: return Co;
		case 35679:
		case 36299:
...
function ko(e, t) {
	let n = ro(t, this.size, 2);
	e.uniform2fv(this.addr, n);
}
function Ao(e, t) {
	let n = ro(t, this.size, 3);
	e.uniform3fv(this.addr, n);
}
function jo(e, t) {
	let n = ro(t, this.size, 4);
...
function No(e, t) {
	let n = ro(t, this.size, 9);
	e.uniformMatrix3fv(this.addr, !1, n);
}
function Po(e, t) {
	let n = ro(t, this.size, 16);
...
function Uo(e, t, n) {
	...
	io(r, a) || (e.uniform1iv(this.addr, a), ao(r, a));
	let o;
	o = this.type === e.SAMPLER_2D_SHADOW ? Ja : qa;
	for (let e = 0; e !== i; ++e) n.setTexture2D(t[e] || o, a[e]);
}
function Wo(e, t, n) {
	let r = this.cache, i = t.length, a = oo(n, i);
	io(r, a) || (e.uniform1iv(this.addr, a), ao(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture3D(t[e] || Xa, a[e]);
}
function Go(e, t, n) {
	let r = this.cache, i = t.length, a = oo(n, i);
	io(r, a) || (e.uniform1iv(this.addr, a), ao(r, a));
	for (let e = 0; e !== i; ++e) n.setTextureCube(t[e] || Za, a[e]);
}
function Ko(e, t, n) {
	let r = this.cache, i = t.length, a = oo(n, i);
	io(r, a) || (e.uniform1iv(this.addr, a), ao(r, a));
	for (let e = 0; e !== i; ++e) n.setTexture2DArray(t[e] || Ya, a[e]);
}
function qo(e) {
	switch (e) {
		case 5126: return Oo;
...
var Jo = class {
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.setValue = Do(t.type);
	}
}, Yo = class {
	constructor(e, t, n) {
		this.id = e, this.addr = n, this.cache = [], this.type = t.type, this.size = t.size, this.setValue = qo(t.type);
	}
}, Xo = class {
	constructor(e) {
...
function $o(e, t, n) {
	...
	for (Zo.lastIndex = 0;;) {
		let a = Zo.exec(r), o = Zo.lastIndex, s = a[1], c = a[2] === "]", l = a[3];
		if (c && (s |= 0), l === void 0 || l === "[" && o + 2 === i) {
			Qo(n, l === void 0 ? new Jo(s, e, t) : new Yo(s, e, t));
			break;
		} else {
			let e = n.map[s];
			e === void 0 && (e = new Xo(s), Qo(n, e)), n = e;
		}
	}
}
var es = class {
	constructor(e, t) {
		...
		for (let r = 0; r < n; ++r) {
			...
			$o(n, e.getUniformLocation(t, n.name), this);
		}
		let r = [], i = [];
...
var as = /* @__PURE__ */ new Y();
function os(e) {
	X._getMatrix(as, X.workingColorSpace, e);
...
var ds = /* @__PURE__ */ new J();
function fs() {
	return X.getLuminanceCoefficients(ds), [
		"float luminance( const in vec3 rgb ) {",
		`	const vec3 weights = vec3( ${ds.x.toFixed(4)}, ${ds.y.toFixed(4)}, ${ds.z.toFixed(4)} );`,
		"	return dot( weights, rgb );",
		"}"
	].join("\n");
}
function ps(e) {
	return [e.extensionClipCullDistance ? "#extension GL_ANGLE_clip_cull_distance : require" : "", e.extensionMultiDraw ? "#extension GL_ANGLE_multi_draw : require" : ""].filter(gs).join("\n");
}
function ms(e) {
	let t = [];
	for (let n in e) {
...
var Cs = /#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;
function ws(e) {
...
function Os(e) {
	return Ds[e.shadowMapType] || "SHADOWMAP_TYPE_BASIC";
}
var ks = {
...
function As(e) {
	return e.envMap === !1 ? "ENVMAP_TYPE_CUBE" : ks[e.envMapMode] || "ENVMAP_TYPE_CUBE";
}
var js = { 302: "ENVMAP_MODE_REFRACTION" };
function Ms(e) {
	return e.envMap === !1 ? "ENVMAP_MODE_REFLECTION" : js[e.envMapMode] || "ENVMAP_MODE_REFLECTION";
}
var Ns = {
...
function Ps(e) {
	return e.envMap === !1 ? "ENVMAP_BLENDING_NONE" : Ns[e.combine] || "ENVMAP_BLENDING_NONE";
}
function Fs(e) {
...
function Is(e, t, n, r) {
	let i = e.getContext(), a = n.defines, o = n.vertexShader, s = n.fragmentShader, c = Os(n), l = As(n), u = Ms(n), d = Ps(n), f = Fs(n), p = ps(n), m = ms(a), h = i.createProgram(), g, _, v = n.glslVersion ? "#version " + n.glslVersion + "\n" : "";
	n.isRawShaderMaterial ? (g = [
		...
		cs("linearToOutputTexel", n.outputColorSpace),
		fs(),
	...
	function C(t) {
		if (e.debug.checkShaderErrors) {
			...
			if (i.getProgramParameter(h, i.LINK_STATUS) === !1) if (l = !1, typeof e.debug.onShaderError == "function") e.debug.onShaderError(i, h, x, S);
				...
				let e = ss(i, x, "vertex"), n = ss(i, S, "fragment");
		...
		i.deleteShader(x), i.deleteShader(S), w = new es(i, h), T = hs(i, h);
	}
	let w;
	...
	return this.isReady = function() {
		return E === !1 && (E = i.getProgramParameter(h, ns)), E;
...
var Ls = 0, Rs = class {
	...
	_getShaderStage(e) {
		...
		return n === void 0 && (n = new zs(e), t.set(e, n)), n;
	}
}, zs = class {
	constructor(e) {
		this.id = Ls++, this.code = e, this.usedTimes = 0;
	}
};
function Bs(e) {
...
function Vs(e, t, n, r, i, a) {
	let o = new Rt(), s = new Rs(), c = /* @__PURE__ */ new Set(), l = [], u = /* @__PURE__ */ new Map(), d = r.logarithmicDepthBuffer, f = r.precision, p = {
	...
	function h(i, o, l, u, h, g) {
		...
		let ke = {
			...
			packedNormalMap: I && i.normalMapType === 0 && Bs(i.normalMap.format),
			metalnessMap: L,
			roughnessMap: se,
			anisotropy: ce,
			anisotropyMap: pe,
	...
	function b(t, n) {
		let r = u.get(n);
		return r === void 0 ? (r = new Is(e, n, t, i), l.push(r), u.set(n, r)) : ++r.usedTimes, r;
	}
	function x(e) {
		if (--e.usedTimes === 0) {
			let t = l.indexOf(e);
...
function Gs() {
	...
	function u(e, t) {
		n.length > 1 && n.sort(e || Us), r.length > 1 && r.sort(t || Ws), i.length > 1 && i.sort(t || Ws);
	}
	function d() {
...
function Ks() {
	...
	function t(t, n) {
		let r = e.get(t), i;
		return r === void 0 ? (i = new Gs(), e.set(t, [i])) : n >= r.length ? (i = new Gs(), r.push(i)) : i = r[n], i;
	}
	function n() {
		e = /* @__PURE__ */ new WeakMap();
	}
...
function $s(e) {
	...
	function n(n, r = 0) {
		let i = t.get(n), a;
		return i === void 0 ? (a = new Qs(e), t.set(n, [a])) : r >= i.length ? (a = new Qs(e), i.push(a)) : a = i[r], a;
	}
	function r() {
...
var ec = "void main() {\n	gl_Position = vec4( position, 1.0 );\n}", tc = "uniform sampler2D shadow_pass;\nuniform vec2 resolution;\nuniform float radius;\nvoid main() {\n	const float samples = float( VSM_SAMPLES );\n	float mean = 0.0;\n	float squared_mean = 0.0;\n	float uvStride = samples <= 1.0 ? 0.0 : 2.0 / ( samples - 1.0 );\n	float uvStart = samples <= 1.0 ? 0.0 : - 1.0;\n	for ( float i = 0.0; i < samples; i ++ ) {\n		float uvOffset = uvStart + i * uvStride;\n		#ifdef HORIZONTAL_PASS\n			vec2 distribution = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( uvOffset, 0.0 ) * radius ) / resolution ).rg;\n			mean += distribution.x;\n			squared_mean += distribution.y * distribution.y + distribution.x * distribution.x;\n		#else\n			float depth = texture2D( shadow_pass, ( gl_FragCoord.xy + vec2( 0.0, uvOffset ) * radius ) / resolution ).r;\n			mean += depth;\n			squared_mean += depth * depth;\n		#endif\n	}\n	mean = mean / samples;\n	squared_mean = squared_mean / samples;\n	float std_dev = sqrt( max( 0.0, squared_mean - mean * mean ) );\n	gl_FragColor = vec4( mean, std_dev, 0.0, 1.0 );\n}", nc = [
	...
	/* @__PURE__ */ new J(0, -1, 0),
	/* @__PURE__ */ new J(0, -1, 0)
], ic = /* @__PURE__ */ new Dt(), ac = /* @__PURE__ */ new J(), oc = /* @__PURE__ */ new J();
function sc(e, t, n) {
	let i = new zr(), a = new q(), s = new q(), c = new St(), l = new ii(), u = new ai(), d = {}, f = n.maxTextureSize, p = {
		0: 1,
		1: 0,
		2: 2
	}, _ = new ti({
	...
	let y = new ar();
	y.setAttribute("position", new Wn(new Float32Array([
		-1,
		-1,
		.5,
		3,
			...
			if (p.camera._reversedDepth = b, p.map === null || v === !0) {
				if (p.map !== null && (p.map.depthTexture !== null && (p.map.depthTexture.dispose(), p.map.depthTexture = null), p.map.dispose()), this.type === 3) {
					...
					p.map = new wt(a.x, a.y, {
						...
						magFilter: o,
						generateMipmaps: !1
					}), p.map.texture.name = d.name + ".shadowMap", p.map.depthTexture = new Vr(a.x, a.y, h), p.map.depthTexture.name = d.name + ".shadowMapDepth", p.map.depthTexture.format = T, p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = r, p.map.depthTexture.magFilter = r;
				} else d.isPointLight ? (p.map = new La(a.x), p.map.depthTexture = new Hr(a.x, m)) : (p.map = new wt(a.x, a.y), p.map.depthTexture = new Vr(a.x, a.y, m)), p.map.depthTexture.name = d.name + ".shadowMap", p.map.depthTexture.format = T, this.type === 1 ? (p.map.depthTexture.compareFunction = b ? 518 : 515, p.map.depthTexture.minFilter = o, p.map.depthTexture.magFilter = o) : (p.map.depthTexture.compareFunction = null, p.map.depthTexture.minFilter = r, p.map.depthTexture.magFilter = r);
...
function cc(e, t) {
	function n() {
		let t = !1, n = new St(), r = null, i = new St(0, 0, 0, 0);
		return {
			setMask: function(n) {
	...
	function r() {
		...
		return {
			...
			setTest: function(t) {
				t ? L(e.DEPTH_TEST) : se(e.DEPTH_TEST);
			},
			setMask: function(t) {
	...
	function i() {
		...
		return {
			setTest: function(n) {
				t || (n ? L(e.STENCIL_TEST) : se(e.STENCIL_TEST));
			},
			setMask: function(r) {
	...
	let F = null, te = {}, ne = e.getParameter(e.SCISSOR_BOX), re = e.getParameter(e.VIEWPORT), ie = new St().fromArray(ne), I = new St().fromArray(re);
	function ae(t, n, r, i) {
	...
	function pe(t, n) {
		t.side === 2 ? se(e.CULL_FACE) : L(e.CULL_FACE);
		let r = t.side === 1;
		...
		s.setTest(i), i && (s.setMask(t.stencilWriteMask), s.setFunc(t.stencilFunc, t.stencilRef, t.stencilFuncMask), s.setOp(t.stencilFail, t.stencilZFail, t.stencilZPass)), _e(t.polygonOffset, t.polygonOffsetFactor, t.polygonOffsetUnits), t.alphaToCoverage === !0 ? L(e.SAMPLE_ALPHA_TO_COVERAGE) : se(e.SAMPLE_ALPHA_TO_COVERAGE);
	}
	function me(t) {
		D !== t && (t ? e.frontFace(e.CW) : e.frontFace(e.CCW), D = t);
	}
	function he(t) {
		t === 0 ? se(e.CULL_FACE) : (L(e.CULL_FACE), t !== O && (t === 1 ? e.cullFace(e.BACK) : t === 2 ? e.cullFace(e.FRONT) : e.cullFace(e.FRONT_AND_BACK))), O = t;
	}
	function ge(t) {
		t !== k && (M && e.lineWidth(t), k = t);
	}
	function _e(t, n, r) {
		t ? (L(e.POLYGON_OFFSET_FILL), (A !== n || ee !== r) && (A = n, ee = r, o.getReversed() && (n = -n), e.polygonOffset(n, r))) : se(e.POLYGON_OFFSET_FILL);
	}
	function ve(t) {
		t ? L(e.SCISSOR_TEST) : se(e.SCISSOR_TEST);
	}
	function ye(t) {
...
function lc(l, u, d, f, p, m, h) {
	...
	function R(e, t) {
		if (t.type === 1015 && u.has("OES_texture_float_linear") === !1 && (t.magFilter === 1006 || t.magFilter === 1007 || t.magFilter === 1005 || t.magFilter === 1008 || t.minFilter === 1006 || t.minFilter === 1007 || t.minFilter === 1005 || t.minFilter === 1008) && W("WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."), l.texParameteri(e, l.TEXTURE_WRAP_S, ue[t.wrapS]), l.texParameteri(e, l.TEXTURE_WRAP_T, ue[t.wrapT]), (e === l.TEXTURE_3D || e === l.TEXTURE_2D_ARRAY) && l.texParameteri(e, l.TEXTURE_WRAP_R, ue[t.wrapR]), l.texParameteri(e, l.TEXTURE_MAG_FILTER, de[t.magFilter]), l.texParameteri(e, l.TEXTURE_MIN_FILTER, de[t.minFilter]), t.compareFunction && (l.texParameteri(e, l.TEXTURE_COMPARE_MODE, l.COMPARE_REF_TO_TEXTURE), l.texParameteri(e, l.TEXTURE_COMPARE_FUNC, fe[t.compareFunction])), u.has("EXT_texture_filter_anisotropic") === !0) {
			...
			if (t.isDepthTexture) u = ee(t.format === E, t.type), _ && (g ? d.texStorage2D(l.TEXTURE_2D, 1, u, e.width, e.height) : d.texImage2D(l.TEXTURE_2D, 0, u, e.width, e.height, 0, s, c, null));
				...
				for (let n = 0, r = h.length; n < r; n++) if (f = h[n], t.format !== 1023) if (s !== null) if (g) {
					if (v) if (t.layerUpdates.size > 0) {
						let e = ia(f.width, f.height, t.format, t.type);
				...
				if (_ && d.texStorage3D(l.TEXTURE_2D_ARRAY, y, u, e.width, e.height, e.depth), v) if (t.layerUpdates.size > 0) {
					let n = ia(e.width, e.height, t.format, t.type);
					for (let r of t.layerUpdates) {
	...
	function be(e, t, n) {
		...
		if (i.__renderTarget = t, (!i.__webglTexture || t.depthTexture.image.width !== t.width || t.depthTexture.image.height !== t.height) && (t.depthTexture.image.width = t.width, t.depthTexture.image.height = t.height, t.depthTexture.needsUpdate = !0), r) {
			if (i.__webglInit === void 0 && (i.__webglInit = !0, t.depthTexture.addEventListener("dispose", M)), i.__webglTexture === void 0) {
				i.__webglTexture = l.createTexture(), d.bindTexture(l.TEXTURE_CUBE_MAP, i.__webglTexture), R(l.TEXTURE_CUBE_MAP, t.depthTexture);
	...
	function Ce(e) {
		...
		if (a) {
			d.bindTexture(l.TEXTURE_CUBE_MAP, r.__webglTexture), R(l.TEXTURE_CUBE_MAP, t);
			...
			for (let t = 0, r = i.length; t < r; t++) {
				...
				(e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (o = e.isWebGL3DRenderTarget ? l.TEXTURE_3D : l.TEXTURE_2D_ARRAY), d.bindTexture(o, a.__webglTexture), R(o, r), ve(n.__webglFramebuffer, e, r, l.COLOR_ATTACHMENT0 + t, o, 0), D(r) && O(o);
			}
			d.unbindTexture();
		} else {
			let i = l.TEXTURE_2D;
			if ((e.isWebGL3DRenderTarget || e.isWebGLArrayRenderTarget) && (i = e.isWebGL3DRenderTarget ? l.TEXTURE_3D : l.TEXTURE_2D_ARRAY), d.bindTexture(i, r.__webglTexture), R(i, t), t.mipmaps && t.mipmaps.length > 0) for (let r = 0; r < t.mipmaps.length; r++) ve(n.__webglFramebuffer[r], e, t, l.COLOR_ATTACHMENT0, i, r);
...
var dc = "\nvoid main() {\n\n	gl_Position = vec4( position, 1.0 );\n\n}", fc = "\nuniform sampler2DArray depthColor;\nuniform float depthWidth;\nuniform float depthHeight;\n\nvoid main() {\n\n	vec2 coord = vec2( gl_FragCoord.x / depthWidth, gl_FragCoord.y / depthHeight );\n\n	if ( coord.x >= 1.0 ) {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x - 1.0, coord.y, 1 ) ).r;\n\n	} else {\n\n		gl_FragDepth = texture( depthColor, vec3( coord.x, coord.y, 0 ) ).r;\n\n	}\n\n}", pc = class {
	...
	getMesh(e) {
		if (this.texture !== null && this.mesh === null) {
			...
			this.mesh = new Or(new Gr(20, 20), n);
		}
		return this.mesh;
	}
	reset() {
	...
	constructor(e, t) {
		super();
		let n = this, r = null, i = 1, a = null, o = "local-floor", s = 1, c = null, u = null, d = null, f = null, p = null, h = null, g = typeof XRWebGLBinding < "u", _ = new pc(), v = {}, b = t.getContextAttributes(), x = null, S = null, C = [], D = [], O = new q(), k = null, A = new Fi();
		A.viewport = new St();
		let ee = new Fi();
		ee.viewport = new St();
		let j = [A, ee], M = new Wi(), N = null, P = null;
		this.cameraAutoUpdate = !0, this.enabled = !1, this.isPresenting = !1, this.getController = function(e) {
			let t = C[e];
			return t === void 0 && (t = new rn(), C[e] = t), t.getTargetRaySpace();
		}, this.getControllerGrip = function(e) {
			let t = C[e];
			return t === void 0 && (t = new rn(), C[e] = t), t.getGripSpace();
		}, this.getHand = function(e) {
			let t = C[e];
			return t === void 0 && (t = new rn(), C[e] = t), t.getHandSpace();
		};
		function F(e) {
			...
			if (r = u, r !== null) {
				if (x = e.getRenderTarget(), r.addEventListener("select", F), r.addEventListener("selectstart", F), r.addEventListener("selectend", F), r.addEventListener("squeeze", F), r.addEventListener("squeezestart", F), r.addEventListener("squeezeend", F), r.addEventListener("end", te), r.addEventListener("inputsourceschange", ne), b.xrCompatible !== !0 && await t.makeXRCompatible(), k = e.getPixelRatio(), e.getSize(O), g && "createProjectionLayer" in XRWebGLBinding.prototype) {
					...
					d = this.getBinding(), f = d.createProjectionLayer(s), r.updateRenderState({ layers: [f] }), e.setPixelRatio(1), e.setSize(f.textureWidth, f.textureHeight, !1), S = new wt(f.textureWidth, f.textureHeight, {
						format: w,
						type: l,
						depthTexture: new Vr(f.textureWidth, f.textureHeight, a, void 0, void 0, void 0, void 0, void 0, void 0, n),
...
}, hc = /* @__PURE__ */ new Dt(), gc = /* @__PURE__ */ new Y();
...
function xc() {
	return bc === null && (bc = new jr(yc, 16, 16, k, g), bc.name = "DFG_LUT", bc.minFilter = o, bc.magFilter = o, bc.wrapS = t, bc.wrapT = t, bc.generateMipmaps = !1, bc.needsUpdate = !0), bc;
}
var Sc = class {
	constructor(e = {}) {
		...
		let re = 0, ie = 0, I = null, ae = -1, oe = null, L = new St(), se = new St(), ce = null, le = new Z(0), ue = 0, de = t.width, fe = t.height, R = 1, pe = null, me = null, he = new St(0, 0, de, fe), ge = new St(0, 0, de, fe), _e = !1, ve = new zr(), ye = !1, be = !1, xe = new Dt(), Se = new J(), Ce = new St(), we = {
			background: null,
			fog: null,
			environment: null,
		...
		try {
			...
			if ("setAttribute" in t && t.setAttribute("data-engine", "three.js r184"), t.addEventListener("webglcontextlost", et, !1), t.addEventListener("webglcontextrestored", K, !1), t.addEventListener("webglcontextcreationerror", tt, !1), z === null) {
				let t = "webgl2";
		...
		this.xr = $e, this.getContext = function() {
			...
			e !== void 0 && (R = e, this.setSize(de, fe, !1));
			...
			de = e, fe = n, t.width = Math.floor(e * R), t.height = Math.floor(n * R), r === !0 && (t.style.width = e + "px", t.style.height = n + "px"), P !== null && P.setSize(t.width, t.height), this.setViewport(0, 0, e, n);
		}, this.getDrawingBufferSize = function(e) {
			return e.set(de * R, fe * R).floor();
		}, this.setDrawingBufferSize = function(e, n, r) {
			de = e, fe = n, R = r, t.width = Math.floor(e * r), t.height = Math.floor(n * r), this.setViewport(0, 0, e, n);
		}, this.setEffects = function(e) {
			if (S === 1009) {
			...
			e.isVector4 ? he.set(e.x, e.y, e.z, e.w) : he.set(e, t, n, r), V.viewport(L.copy(he).multiplyScalar(R).round());
		}, this.getScissor = function(e) {
			return e.copy(ge);
		}, this.setScissor = function(e, t, n, r) {
			e.isVector4 ? ge.set(e.x, e.y, e.z, e.w) : ge.set(e, t, n, r), V.scissor(se.copy(ge).multiplyScalar(R).round());
		...
		this.renderBufferDirect = function(e, t, n, r, i, a) {
			t === null && (t = we);
			let o = i.isMesh && i.matrixWorld.determinant() < 0, s = vt(e, t, n, r, i);
			V.setMaterial(r, o);
			let c = n.index, l = 1;
			if (r.wireframe === !0) {
		...
		function q(e, t, n) {
			e.transparent === !0 && e.side === 2 && e.forceSinglePass === !1 ? (e.side = 1, e.needsUpdate = !0, mt(e, t, n), e.side = 0, e.needsUpdate = !0, mt(e, t, n), e.side = 2) : mt(e, t, n);
		}
		...
		let ct = new oa();
		ct.setAnimationLoop(ot), typeof self < "u" && ct.setContext(self), this.setAnimationLoop = function(e) {
			at = e, $e.setAnimationLoop(e), e === null ? ct.stop() : ct.start();
		}, $e.addEventListener("sessionstart", st), $e.addEventListener("sessionend", Y), this.render = function(e, t) {
			...
			if (e.matrixWorldAutoUpdate === !0 && e.updateMatrixWorld(), t.parent === null && t.matrixWorldAutoUpdate === !0 && t.updateMatrixWorld(), $e.enabled === !0 && $e.isPresenting === !0 && (P === null || P.isCompositing() === !1) && ($e.cameraAutoUpdate === !0 && $e.updateCamera(t), t = $e.getCamera()), e.isScene === !0 && e.onBeforeRender(F, e, t, I), j = ze.get(e, N.length), j.init(t), j.state.textureUnits = U.getTextureUnits(), N.push(j), xe.multiplyMatrices(t.projectionMatrix, t.matrixWorldInverse), ve.setFromProjectionMatrix(xe, Re, t.reversedDepth), be = this.localClippingEnabled, ye = Be.init(this.clippingPlanes, be), k = Le.get(e, M.length), k.init(), M.push(k), $e.enabled === !0 && $e.isPresenting === !0) {
				...
				e !== null && lt(e, t, -Infinity, F.sortObjects);
			}
			lt(e, t, 0, F.sortObjects), k.finish(), F.sortObjects === !0 && k.sort(pe, me), Te = $e.enabled === !1 || $e.isPresenting === !1 || $e.hasDepthSensing() === !1, Te && Ue.addToRenderList(k, e), this.info.render.frame++, ye === !0 && Be.beginShadows();
			...
			if (Ve.render(i, e, t), ye === !0 && Be.endShadows(), this.info.autoReset === !0 && this.info.reset(), (r && P.hasRenderPass()) === !1) {
				...
				} else r.length > 0 && dt(n, r, e, t), Te && Ue.render(e), ut(k, e, t);
			}
		...
		function lt(e, t, n, r) {
			...
			let i = e.children;
			for (let e = 0, a = i.length; e < a; e++) lt(i[e], t, n, r);
		}
		function ut(e, t, n, r) {
			let { opaque: i, transmissive: a, transparent: o } = e;
			j.setupLightsView(n), ye === !0 && Be.setGlobalState(F.clippingPlanes, n), r && V.viewport(L.copy(r)), i.length > 0 && ft(i, t, n), a.length > 0 && ft(a, t, n), o.length > 0 && ft(o, t, n), V.buffers.depth.setTest(!0), V.buffers.depth.setMask(!0), V.buffers.color.setMask(!0), V.setPolygonOffset(!1);
		}
		function dt(e, t, n, r) {
			...
			F.setRenderTarget(a), F.getClearColor(le), ue = F.getClearAlpha(), ue < 1 && F.setClearColor(16777215, .5), F.clear(), Te && Ue.render(n);
			let f = F.toneMapping;
			F.toneMapping = 0;
			let p = r.viewport;
			if (r.viewport !== void 0 && (r.viewport = void 0), j.setupLightsView(r), ye === !0 && Be.setGlobalState(F.clippingPlanes, r), ft(e, n, r), U.updateMultisampleRenderTarget(a), U.updateRenderTargetMipmap(a), B.has("WEBGL_multisampled_render_to_texture") === !1) {
				let e = !1;
				for (let i = 0, a = t.length; i < a; i++) {
					let { object: a, geometry: o, material: s, group: c } = t[i];
					if (s.side === 2 && a.layers.test(r.layers)) {
						let t = s.side;
						s.side = 1, s.needsUpdate = !0, pt(a, n, r, o, s, c), s.side = t, s.needsUpdate = !0, e = !0;
					}
				}
				e === !0 && (U.updateMultisampleRenderTarget(a), U.updateRenderTargetMipmap(a));
			}
			F.setRenderTarget(s, u, d), F.setClearColor(le, ue), p !== void 0 && (r.viewport = p), F.toneMapping = f;
		}
		function ft(e, t, n) {
			let r = t.isScene === !0 ? t.overrideMaterial : null;
			for (let i = 0, a = e.length; i < a; i++) {
				let a = e[i], { object: o, geometry: s, group: c } = a, l = a.material;
				l.allowOverride === !0 && r !== null && (l = r), o.layers.test(n.layers) && pt(o, t, n, s, l, c);
			}
		}
		...
		function mt(e, t, n) {
			...
			let d = l.get(c);
			if (d !== void 0) {
				if (r.currentProgram === d && r.lightsStateVersion === o) return gt(e, s), d;
		...
		function vt(e, t, n, r, i) {
			...
			if ((D.position !== void 0 || D.normal !== void 0 || D.color !== void 0) && We.update(i, n, x), (C || v.receiveShadow !== i.receiveShadow) && (v.receiveShadow = i.receiveShadow, T.setValue(z, "receiveShadow", i.receiveShadow)), (r.isMeshStandardMaterial || r.isMeshLambertMaterial || r.isMeshPhongMaterial) && r.envMap === null && t.environment !== null && (E.envMapIntensity.value = t.environmentIntensity), E.dfgLUT !== void 0 && (E.dfgLUT.value = xc()), C) {
				if (T.setValue(z, "toneMappingExposure", F.toneMappingExposure), v.needsLights && yt(E, w), a && r.fog === !0 && Ie.refreshFogUniforms(E, a), Ie.refreshMaterialUniforms(E, r, R, fe, j.state.transmissionRenderTarget[e.id]), v.needsLights && v.lightProbeGrid) {
				...
				es.upload(z, ht(v), E, U);
			}
			if (r.isShaderMaterial && r.uniformsNeedUpdate === !0 && (es.upload(z, ht(v), E, U), r.uniformsNeedUpdate = !1), r.isSpriteMaterial && T.setValue(z, "center", i.center), T.setValue(z, "modelViewMatrix", i.modelViewMatrix), T.setValue(z, "normalMatrix", i.normalMatrix), T.setValue(z, "modelMatrix", i.matrixWorld), r.uniformsGroups !== void 0) {
		...
		this.setRenderTarget = function(e, t = 0, n = 0) {
			...
			if (e) {
				...
				if (o.__useDefaultFramebuffer !== void 0) {
					V.bindFramebuffer(z.FRAMEBUFFER, o.__webglFramebuffer), L.copy(e.viewport), se.copy(e.scissor), ce = e.scissorTest, V.viewport(L), V.scissor(se), V.setScissorTest(ce), ae = -1;
					return;
				...
				e.isWebGLCubeRenderTarget ? (r = Array.isArray(c[t]) ? c[t][n] : c[t], i = !0) : r = e.samples > 0 && U.useMultisampledRTT(e) === !1 ? H.get(e).__webglMultisampledFramebuffer : Array.isArray(c) ? c[n] : c, L.copy(e.viewport), se.copy(e.scissor), ce = e.scissorTest;
			} else L.copy(he).multiplyScalar(R).floor(), se.copy(ge).multiplyScalar(R).floor(), ce = _e;
			if (n !== 0 && (r = xt), V.bindFramebuffer(z.FRAMEBUFFER, r) && V.drawBuffers(e, r), V.viewport(L), V.scissor(se), V.setScissorTest(ce), i) {
		...
		let Ct = z.createFramebuffer(), Tt = z.createFramebuffer();
		this.copyTextureToTexture = function(e, t, n = null, r = null, i = 0, a = 0) {
			...
			if (e.isDepthTexture) {
				...
				V.bindFramebuffer(z.READ_FRAMEBUFFER, Ct), V.bindFramebuffer(z.DRAW_FRAMEBUFFER, Tt);
...
}, Cc = document.body?.dataset.arenaRenderer === "3d" || new URLSearchParams(window.location.search).get("renderer") === "3d", wc = class {
	root;
	status;
	scene = new dn();
	camera = new Fi(42, 1, .1, 100);
	renderer = new Sc({
		antialias: !0,
		alpha: !0
	});
	boardGroup = new tn();
	cardMeshes = /* @__PURE__ */ new Map();
	orbMeshes = /* @__PURE__ */ new Map();
	clock = new ra();
	frame = 0;
	disposed = !1;
	constructor() {
		this.root = document.createElement("section"), this.root.className = "az3d-stage", this.root.setAttribute("aria-hidden", "true"), this.status = document.createElement("div"), this.status.className = "az3d-status", this.status.innerHTML = "<b>3D</b><span>Waiting for arena state...</span>", document.body.prepend(this.root), document.body.appendChild(this.status), this.root.appendChild(this.renderer.domElement), this.renderer.setPixelRatio(Math.min(window.devicePixelRatio || 1, 2)), this.renderer.outputColorSpace = Me, this.scene.fog = new un("#05050b", 10, 28), this.camera.position.set(0, 7.2, 8.4), this.camera.lookAt(0, 0, 0), this.createLights(), this.createTable(), this.scene.add(this.boardGroup), window.addEventListener("resize", this.resize), this.resize(), this.loadManifest(), this.tick();
	}
	renderArenaState(e) {
		let t = window.AmbitionzArenaRendererAdapter;
		if (!t) return;
		let n = t.normalizeArenaState(e), r = t.boardSlots(n), i = /* @__PURE__ */ new Set();
		r.forEach((e, t) => {
			let n = `${e.owner}-${e.slot}`;
			i.add(n);
			let r = this.cardMeshes.get(n) || this.createCardMesh(n), a = this.orbMeshes.get(n) || this.createOrbMesh(n), o = (t % 3 - 1) * 1.75, s = e.owner === "enemy" ? -1.55 : 1.55;
			r.position.set(o, e.card ? .22 : .08, s), r.rotation.set(-Math.PI / 2.25, 0, e.owner === "enemy" ? Math.PI : 0), r.scale.setScalar(e.card ? 1 : .88), r.userData.targetY = e.card ? .22 : .08;
			let c = r.material, l = e.card?.colors?.primary || (e.owner === "enemy" ? "#46506a" : "#d6a84c");
			c.color.set(l), c.emissive.set(e.card ? l : "#111827"), c.emissiveIntensity = e.card ? .18 : .05, c.opacity = e.card ? .96 : .28, a.position.set(o, e.card ? .55 : .26, s), a.scale.setScalar(e.card ? 1 : .45), a.userData.targetY = e.card ? .55 : .26, a.userData.active = !!e.card;
			let u = a.material;
			u.color.set(e.card?.colors?.accent || l), u.emissive.set(e.card?.colors?.secondary || l), u.emissiveIntensity = e.card ? .55 : .08, u.opacity = e.card ? .82 : .18;
		});
		for (let [e, t] of this.cardMeshes.entries()) i.has(e) || (t.removeFromParent(), this.cardMeshes.delete(e));
		for (let [e, t] of this.orbMeshes.entries()) i.has(e) || (t.removeFromParent(), this.orbMeshes.delete(e));
		this.status.innerHTML = ["<b>3D</b>", `<span>Round ${n.round} · ${n.phase} · HP ${n.me.hp}/${n.enemy.hp}</span>`].join("");
	}
	dispose() {
		this.disposed = !0, window.removeEventListener("resize", this.resize), this.renderer.dispose(), this.root.remove(), this.status.remove();
	}
	createLights() {
		let e = new Ci("#fff4d0", "#141827", 1.3), t = new Bi("#fff0bf", 2.2), n = new Li("#6dc9ff", 2.4, 16);
		t.position.set(-3, 8, 4), n.position.set(4, 2.8, -3), this.scene.add(e, t, n);
	}
	createTable() {
		let e = new Or(new Wr(7.2, .26, 5.4), new ri({
			color: "#171018",
			roughness: .82,
			metalness: .2
		}));
		e.position.y = -.08, this.scene.add(e);
		let t = new ri({
			color: "#d6a84c",
			emissive: "#d6a84c",
		...
		[-1.55, 1.55].forEach((e) => {
			let n = new Or(new Wr(6.1, .035, 1.25), t.clone());
			n.position.set(0, .08, e), this.scene.add(n);
		});
		let n = new Or(new Wr(6.7, .05, .08), new ri({
			color: "#fff1bb",
			emissive: "#d6a84c",
			emissiveIntensity: .38
		}));
		n.position.set(0, .12, 0), this.scene.add(n);
	}
	createCardMesh(e) {
		let t = new Or(new Wr(1.08, .07, 1.48), new ri({
			color: "#d6a84c",
			roughness: .46,
			metalness: .12,
			transparent: !0,
		...
		return t.name = e, t.userData.targetY = .1, this.boardGroup.add(t), this.cardMeshes.set(e, t), t;
	}
	createOrbMesh(e) {
		let t = new Or(new Kr(.16, 24, 12), new ri({
			color: "#fff1bb",
			emissive: "#d6a84c",
		...
		return t.name = `${e}-orb`, t.userData.targetY = .26, this.boardGroup.add(t), this.orbMeshes.set(e, t), t;
	}
	resize = () => {
		let e = window.innerWidth || 1, t = window.innerHeight || 1;
		this.camera.aspect = e / t, this.camera.updateProjectionMatrix(), this.renderer.setSize(e, t, !1);
	};
	tick = () => {
		if (this.disposed) return;
		let e = this.clock.getElapsedTime();
		this.boardGroup.rotation.y = Math.sin(e * .25) * .035;
		for (let t of this.cardMeshes.values()) {
			let n = Number(t.userData.targetY || .1);
			t.position.y += (n + Math.sin(e * 2.4 + t.position.x) * .018 - t.position.y) * .08;
		}
		for (let t of this.orbMeshes.values()) {
			let n = Number(t.userData.targetY || .25), r = t.userData.active ? Math.sin(e * 4 + t.position.x) * .035 : 0;
			t.position.y += (n + r - t.position.y) * .1, t.rotation.y += .012;
		}
		this.renderer.render(this.scene, this.camera), this.frame = window.requestAnimationFrame(this.tick);
	};
	loadManifest() {
		fetch("/static/assets/arena3d/manifest.json").then((e) => e.ok ? e.json() : null).then((e) => {
			window.__ambitionzArena3dManifest = e;
		}).catch(() => {
...
if (Cc) {
	let e = () => {
		let e = new wc();
		window.__ambitionzArena3d = e, window.addEventListener("ambitionz:arena_state_rendered", (t) => {
			let n = t.detail || {};
			e.renderArenaState(n.payload || n.state);
		}), window.__ambitionzArena48State && e.renderArenaState(window.__ambitionzArena48State);
	};
